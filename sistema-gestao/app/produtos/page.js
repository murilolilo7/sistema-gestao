  ...
  return (
    <div>
      ...
      <p className="text-slate-500 mb-6">
        Cadastre produtos e acompanhe o estoque disponível.
      </p>
      ...
      <form
        ...
        className="mb-8 rounded-xl border border-slate-200 bg-white p-5 shadow-sm grid grid-cols-1 sm:grid-cols-4 gap-3 items-end"
      >
      ...
      <div className="rounded-xl border border-slate-200 bg-white shadow-sm overflow-hidden">
        {loading ? (
          ...
          <p className="p-6 text-sm text-slate-500">
            Nenhum produto cadastrado ainda. Use o formulário acima para
